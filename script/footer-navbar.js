    function generateNavbar() {
        return (
            `
            <div class="bg-[#D9D9D990] backdrop-blur fixed w-full flex justify-between items-center py-4 px-8">
            <img src="pictures/logo.png" alt="" class="w-[201px]">
            <nav class="flex relative">
                <a class="text-2xl font-bold text-[#FF0000] pr-8" href="#">HOME </a>
                <div id="clothes" class="">
                    ...
                    <div id="sex" class="absolute flex flex-col text-white bg-black hidden  ">
                        <a href="" class="px-4">Man</a> <br>
                        <a href="" class="bg-red-400 py-1 px-4">Woman</a>
                    </div>
                </div>
                <div id="eq" class="">
                    ...
                    <div id="se" class="absolute flex flex-col text-white bg-black hidden">
                        ...
                        <a href="" class="bg-red-400 py-1 px-4">Accessoir</a>
                    </div>
                </div>
                <a class="text-2xl pr-8 font-bold" href="#">NUTRITION </a>
                <a class="text-2xl pr-8 font-bold" href="#">COATCHING </a>
            </nav>
            <div>
                <a href="">ico</a>
                <a href="">ico</a>
